...
\begin{frame}
   ...
   \only<4>{
      \framesubtitle{Weisser, 2022}
      \begin{figure}
         \includegraphics[width = .7\textwidth]{weisser_1.png}
      \end{figure}
   }
   \only<5>{
      \begin{figure}
         \framesubtitle{Weisser, 2022}
         \includegraphics[width = .7\textwidth]{weisser_2.png}
      \end{figure}
   }
...
\begin{frame}
   ...
   \only<+>{
      ...
      \begin{tikzpicture}
          ...
          \node at (6.5,-2.75) {\includegraphics[width = 7cm]{esp_gdelt_themes_lines.png}};
      \end{tikzpicture}
   }
   \only<+>{
      \framesubtitle{How to construct a request?}
