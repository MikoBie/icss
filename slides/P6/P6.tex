...
\begin{frame}
    \frametitle{For the class in 2 weeks}
    \begin{enumerate}
        \item Find a scientific article that uses NLP tools (Google Scholar). It should be published in a peer-reviewed social science journal and have at least 10 citations.
        \item Read it.
        ...
        \item Deadline: \textbf{13th April 2026, 14:59 AM}.
    \end{enumerate}
\end{frame}
\end{document}
