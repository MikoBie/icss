...
\begin{frame}
   ...
   \only<1>{
      \begin{figure}
         \includegraphics[width = .3\textwidth]{vogue.jpg}
...
\begin{frame}
   ...
   \only<3>{
      ...
      \begin{figure}
         \centering
         \includegraphics[width = .8\textwidth]{grid.png}
      \end{figure}
   }
   \only<4>{
      \frametitle{Cellular automata}
      ...
      \begin{figure}
         \includegraphics[width = .8\textwidth]{life.png}
      \end{figure}
   ...
   \only<5>{
      ...
      \framesubtitle{Game of life (Conway, 1970)}
      \begin{figure}
         \animategraphics[loop,controls, width = .8\textwidth]{10}{game_life-}{0}{148}
...
\begin{frame}
    ...
    \begin{enumerate}
        \item Find a scientific article that uses computer simulations (Google Scholar). It should be published in a peer-reviewed social science journal and have at least 10 citations.
        \item Read it.
        ...
        \item Deadline: \textbf{12th December 2025, 11:59 AM}.
    \end{enumerate}
\end{frame}
