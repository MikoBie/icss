...
\begin{frame}
    \frametitle{Measuring migration 2.0}
    \framesubtitle{Tjaden, 2021}
    \begin{figure}
        \centering
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Deadline: \textbf{16th March 2026, 2:59 PM}.
    \end{enumerate}
\end{frame}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Tjaden, J. (2021). Measuring migration 2.0: A review of digital data sources. Comparative Migration Studies, 9(1), 59. \href{https://doi.org/10.1186/s40878-021-00273-x}{\textcolor{blue}{https://doi.org/10.1186/s40878-021-00273-x}}
