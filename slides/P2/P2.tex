...
\begin{frame}
    ...
    \only<+>{
        \framesubtitle{Guess et al. (2023)}
        \begin{figure}
            \centering
            \includegraphics[width = .5\textwidth]{algorithms.png}
        \end{figure}
    }
    \only<+>{
        \begin{figure}
            \centering
            \includegraphics[width = .6\textwidth]{news_social_media.png}
            \caption{From \href{https://www.pewresearch.org/journalism/fact-sheet/social-media-and-news-fact-sheet/}{\color{blue}{Pew Research Center}}}
        \end{figure}
    }
    \only<+>{
        \begin{figure}
            \centering
            \includegraphics[width = .5\textwidth]{social_media_type.png}
            \caption{From \href{https://www.pewresearch.org/journalism/fact-sheet/social-media-and-news-fact-sheet/}{\color{blue}{Pew Research Center}}}
        \end{figure}
    }
    \only<+>{
        \begin{figure}
            \centering
            \includegraphics[width = .4\textwidth]{social_media_demographics.png}
            \caption{From \href{https://www.pewresearch.org/journalism/fact-sheet/social-media-and-news-fact-sheet/}{\color{blue}{Pew Research Center}}}
        \end{figure}
    }
\end{frame}
...
\begin{frame}
    ...
    \only<+>{
        \begin{figure}
            \includegraphics[width = .5\textwidth]{png/ISOC-Dark-RGB_Logo_400px.png}
...
\begin{frame}
    ...
    \only<+>{
        \centering
        \begin{tikzpicture}
            \node at (0,0) {\includegraphics[width = 2cm]{email.png}};
            \node [align = center] at (0,-2) {\textsc{Congrats} \\ \textsc{email}};
            \node at (3,0) {\includegraphics[width = 2cm]{telephone.png}};
            \node [align = center] at (3,-2) {\textsc{Angry} \\ \textsc{call}};
            \node at (6,0) {\includegraphics[width = 2cm]{loyalty-card.png}};
            \node [align = center] at (6,-2) {\textsc{Loyalty} \\ \textsc{card}};
            \node at (9,0) {\includegraphics[width = 2cm]{pregnancy-test.png}};
            \node [align = center] at (9,-2) {\textsc{Pregnancy} \\ \textsc{test}};
        \end{tikzpicture}
    }
    \only<+>{
        \begin{figure}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Guess, A., M., et al. (2023) How do social media feed algorithms affect attitudes and behavior in an election campaign? Science, 381,398-404 \href{https://doi.org/10.1126/science.abp9364}{\color{blue}{https://doi.org/10.1126/science.abp9364}}
    \end{enumerate}
\end{frame}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Deadline: \textbf{2nd March 2026, 2:59 PM}.
    \end{enumerate}
\end{frame}
