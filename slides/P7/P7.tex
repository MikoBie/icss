...
\begin{frame}
   ...
   \begin{itemize}
      \item Humans are "storytelling animals" (Gottschall, 2012). People are not computers. We think not with data, but with storie (Robinson \& Hawpe, 1986).
      \item The Psychology of Life Stories (McAdams, 2001).
      \item Whenever we find ourselves in a new situation or face a decision we use narratives to understand the circumstances and compare potential scenarios (Beach, 2021). Stories are thus the primary tool by which we experience the world. They provide meaning to reality (Popova, 2015). 
      \item Many studies suggest that fake news tend to generate more attention and spread faster than true information. One of the reasons for that may be that they represent attractive narrative structures (Baptista \& Gradim, 2020). \alert{Fake news is perceived as more interesting and more relevant.}
   \end{itemize}
\end{frame}
...
\begin{frame}
   ...
   \only<3>{
      \begin{definition}
         ...
         different stories about vaccines, masks, and lockdowns may occur to be the
